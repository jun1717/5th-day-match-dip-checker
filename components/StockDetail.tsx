        ...
        <section className="surface">
          ...
          <div className="surface-body">
            <div className="detail-grid">
              ...
              <Detail label="5日線乖離率" value={formatPercent(primary.ma5Deviation, 2)} />
              <Detail label="25日線乖離率" value={formatPercent(primary.ma25Deviation, 2)} />
              <Detail label="5日線傾き" value={formatNumber(primary.ma5Slope, 2)} />
              <Detail label="25日線傾き" value={formatNumber(primary.ma25Slope, 2)} />
      ...
      <section className="surface">
        ...
        <div className="surface-body">
          <div className="detail-grid">
            ...
            <Detail label="年初来高値乖離" value={formatPercent(primary.yearHighDeviation, 2)} />
            <Detail label="5日騰落率" value={formatPercent(primary.return5d, 2)} />
            <Detail label="20日騰落率" value={formatPercent(primary.return20d, 2)} />
          </div>
        </div>
      </section>
